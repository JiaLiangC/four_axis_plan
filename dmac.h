...
Macro definitions
***********************************************************************************************************************/
#define _10_DMA0_SFR_ADDRESS                (0x10U)
#define _FE20_DMA0_RAM_ADDRESS              (0xFE20U)
#define _0020_DMA0_BYTE_COUNT               (0x0020U)
...
void DMA1_Config(uint16_t cnt,uint16_t *RAM_ADDRESS);
